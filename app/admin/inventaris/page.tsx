        ...
        <div className="flex-1 bg-[#f5f7fb] flex flex-col min-h-screen">
            <main className="flex-1 flex flex-col overflow-auto">
                ...
                <div className="p-8">
                    ...
                    <p className="text-gray-500 mb-6">Kelola data barang inventaris (Administrator)</p>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <select
                                            className="w-full border rounded-xl pl-4 pr-10 py-3 bg-white appearance-none focus:ring-2 focus:ring-blue-500 outline-none transition-all"
