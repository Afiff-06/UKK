      ...
      <main className="p-4 sm:p-8 flex-1">
        <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
          ...
          <div className="bg-white rounded-[2rem] shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden border border-gray-100/60">
            <div className={`h-32 bg-gradient-to-r ${getGradient(role)} relative overflow-hidden`}>
              <div className="absolute inset-0 bg-black/10"></div>
              <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
            </div>
            
            <div className="px-6 sm:px-10 pb-8 flex flex-col md:flex-row items-center md:items-end -mt-16 gap-6 md:gap-8 relative z-10">
            ...
            <div className="bg-white rounded-[2rem] shadow-sm hover:shadow-md transition-shadow duration-300 p-6 sm:p-8 border border-gray-100/60">
              ...
              <div className="space-y-6">
                ...
                <InfoItem 
                  ...
                  value={profile?.created_at ? new Date(profile.created_at).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' }) : '-'} 
                />
              </div>
            </div>
