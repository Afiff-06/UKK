    ...
    return (
        <div className="min-h-screen bg-[#f5f7fb] w-full">
            <main className="flex-1 flex flex-col">
                <Header title="Dashboard Pegawai" />

                <div className="p-8">
                    {/* WELCOME */}
                    <h1 className="text-4xl font-bold text-gray-800 mb-2">
                        Selamat Datang, {profile?.nama || 'Pegawai'}!
                    </h1>
                    <p className="text-gray-500 mb-8 max-w-3xl">
                        Lihat status peminjaman dan ajukan pengembalian barang.
                    </p>
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
                                ...
                                <StatCard
                                    ...
                                    value={stats.recentPeminjaman.filter(p => p.status === 'pending').length.toString()}
                                    color="orange"
                                />
                                <StatCard
                                    icon={<CheckCircle />}
                                    title="Telah Dikembalikan"
                                    value={stats.recentPeminjaman.filter((p) => ['dikembalikan', 'terlambat'].includes(p.status)).length.toString()}
                                    color="green"
                                />
                                <StatCard
                                    icon={<AlertCircle />}
